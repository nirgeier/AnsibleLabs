...
- [01. Install Ansible](#01-Install-Ansible)
  - [01.01. Build the Ansible container](#0101-Build-the-Ansible-container)
  - [01.02. Build the Dummy servers](#0102-Build-the-Dummy-servers)
...
- This lab contains teh `Ansible server` demo servers for the playground.
...
ssh-keygen -f "/root/known_hosts" -R "[localhost]:2225"

# Add the certificates to the authorized_keys on our ansible container
sudo ssh -i .ssh/id_rsa -p 2224 root@localhost -o StrictHostKeyChecking=accept-new
sudo ssh -i .ssh/id_rsa -p 2225 root@localhost -o StrictHostKeyChecking=accept-new
```
